<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="OTMasters.aspx.cs" Inherits="AECLOGIC.ERP.HMS.HMS.OTMasters" %>
                        ...
                        <td style="width: 100%">
                            <asp:GridView ID="gvWages" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CssClass="anchor__grd edit_grd" CommandArgument='<%#Eval("OTID")%>'
