<%@ Page Title="" Language="C#"   AutoEventWireup="True"
    CodeBehind="ESIReport.aspx.cs" Inherits="AECLOGIC.ERP.HMS.ESIReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <asp:UpdatePanel runat="server" ID="updpnl">
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td>
                        <cc1:Accordion ID="ESIRptAccordion" runat="server" HeaderCssClass="accordionHeader"
                            HeaderSelectedCssClass="accordionHeaderSelected" ContentCssClass="accordionContent"
                            AutoSize="None" FadeTransitions="false" TransitionDuration="50" FramesPerSecond="40"
                            RequireOpenedPane="false" SuppressHeaderPostbacks="true">
                            <Panes>
                                <cc1:AccordionPane ID="ESIRptAccordionPane1" runat="server" HeaderCssClass="accordionHeader"
    ...
    <asp:Panel ID="pnlESIRV" runat="server" Width="100%">
        <rsweb:ReportViewer ID="ESIRV" runat="server" Font-Names="Verdana" Font-Size="8pt"
            InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt"
            Width="100%">
            <LocalReport ReportPath="RDLC_Reports\ESI.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </asp:Panel>
</asp:Content>
