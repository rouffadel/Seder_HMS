...
{
    public partial class VacationSettlement2 : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        #region Variables
        ...
        protected void lnkatt_Viewk_click(object sender, EventArgs e)
        {
            try
            {
                ...
                tblAtt.Rows.Clear();
                DataSet ds = new DataSet();
                ds = objatt.GetAttendanceByMonth_Cursor(Convert.ToInt32(Month), Convert.ToInt32(Year), Convert.ToInt32(ddldepartment.SelectedValue), Convert.ToInt32(ddlworksite.SelectedValue), EmpID, string.Empty, null);
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkEnch.Checked)
                    ...
                    i = false;
                string url = "VacationalPrint2.aspx?Empid=" + Empid + "&Date=" + date + "&Checked=" + i;
                string fullURL = "window.open('" + url + "', '_blank' );";
                ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);
            }
            catch (Exception ex)
        ...
        public DataView BindTransdetails(string TransId)
        {
            ...
            if (!chkEnch.Checked)
            {
                ...
                //            if (GVrow.RowIndex == 0)
                //            {
                //                LinkButton lnkEAL = (LinkButton)GVrow.FindControl("lnkEAL");
                //                lnkEAL.Visible = true;
                //            }
                //        }
                //    }
