<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyPaymentsApprovedV4.aspx.cs" Inherits="AECLOGIC.ERP.HMSV1.MonthlyPaymentsApprovedV4V1" MasterPageFile="~/Templates/CommonMaster.master" %>
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                            <tr>
                                <td>Name:
                                    ...
                                    &nbsp;&nbsp;  &nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnNoSalaryEmployees" runat="server" Text="No Salary Employees" 
                                        TabIndex="7" AccessKey="i" ToolTip="[Alt+i OR Alt+i+Enter]" CssClass="btn btn-success" Visible="false"
                                        Width="120px" />
                                                                       <%--  Format
                                                                       <span style="color: #ff0000">*</span>--%>
                                    <asp:DropDownList ID="ddlFormat" runat="server" CssClass="droplist" Visible="false">
                                        <%-- <asp:ListItem Text="Select" Value="0" />
                                                                         <asp:ListItem Text="SCC HR Format" Value="1" />
                                                                         <asp:ListItem Text="SSK HR Format1" Value="2" />
                                                                         <asp:ListItem Text="SSK HR Format2" Value="3" />
                                                                         <asp:ListItem Text="SCC Bank Format" Value="4" />
                                                                         <asp:ListItem Text="WS wise summary" Value="5" />
                                                                         <asp:ListItem Text="WS wise Details" Value="6" />--%>
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td>
                                    <b>Transaction Id :</b>
                                    <%-- <asp:Label ID="lbltransid" runat="server" Font-Bold="true" Font-Size="12px"></asp:Label>--%>
                                    <asp:LinkButton ID="lnkTransid" runat="server" Font-Bold="true" Font-Size="12px" OnClick="lnkTransid_Click" Text=""></asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
                                <td>
