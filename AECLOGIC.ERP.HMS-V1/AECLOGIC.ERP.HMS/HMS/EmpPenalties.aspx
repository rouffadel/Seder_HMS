<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="EmpPenalties.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master"
    Inherits="AECLOGIC.ERP.HMSV1.EmpPenaltiesV1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
   ...
   <asp:UpdatePanel ID="salariesupdpanel" runat="server">
    ...
    <table id="tblAdd" visible="false" runat="server" width="100%">
        ...
        <tr>
            <td colspan="2">
                <asp:ListBox ID="lstItems" Rows="6" Width="300Px" CssClass="box box-primary" runat="server" SelectionMode="Multiple">
                </asp:ListBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvRemiItems" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    OnRowDataBound="gvRemiItems_RowDataBound" CssClass="gridview"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="80Px" HeaderText="PenaltyItem">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Penality Rate">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-Width="100Px" HeaderText="Purpose">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPurpose" runat="server" Height="50" Text='<%# DataBinder.Eval(Container.DataItem,"Purpose") %>'
                                    TextMode="MultiLine"  Style="vertical-align:bottom;" Width="200"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Proof">
                            <ItemTemplate>
                                <asp:FileUpload autopostback="true"  ID="UploadProof" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
    ...
    <table id="tblView" runat="server" width="100%" visible="false">
        <tr runat="server" id="trACPosting">
            <td>
                                ...
                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td colspan="2"">
                                            ...
                                            <b>Employee:</b>
                                            <asp:DropDownList ID="ddlFilterEmp" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlFilterEmp_SelectedIndexChanged"
                                            ...
                                            <asp:TextBox ID="txtFilterEmp" runat="server" CssClass="droplist" AccessKey="2" ToolTip="[Alt+2]" TabIndex="2"></asp:TextBox>
                                            ...
                                            MinimumPrefixLength="1" ServiceMethod="GetCompletionListEmp" ServicePath="" TargetControlID="txtFilterEmp"
                                            UseContextKey="True" CompletionInterval="10" CompletionListCssClass="autocomplete_completionListElement"
                                            CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                        </cc1:AutoCompleteExtender>
                                            &nbsp;<asp:TextBox ID="txtFilterEmpID" runat="server" CssClass="droplist" AccessKey="3" ToolTip="[Alt+3]" TabIndex="3"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="FTBEmpID" runat="server" TargetControlID="txtFilterEmpID" FilterType="Numbers"></cc1:FilteredTextBoxExtender>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvView" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    CssClass="gridview" OnSelectedIndexChanged="gvView_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:TemplateField Visible="false">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEdit" CssClass="anchor__grd edit_grd " CommandArgument='<%#Eval("EmpID") %>' CommandName="Edit"
                            ...
                            <Content>
                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td colspan="2">
                                            <b>Employee :</b>
                                            <asp:DropDownList ID="ddlTransfer" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTransfer_SelectedIndexChanged"
                                                CssClass="droplist" AccessKey="1" ToolTip="[Alt+1]" TabIndex="1">
                                            </asp:DropDownList>
                                            <cc1:ListSearchExtender ID="ListSearchExtender3" IsSorted="true" PromptText="Type Here To Search..."
                                                PromptPosition="Top" PromptCssClass="PromptText" QueryPattern="Contains" runat="server"
                                                TargetControlID="ddlTransfer" />
                                            <asp:TextBox ID="txtTranferSearch" runat="server" CssClass="droplist" AccessKey="2" ToolTip="[Alt+2]" TabIndex="2"></asp:TextBox>
                                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="txtTranferSearch"
                                                WatermarkCssClass="Watermarktxtbox" WatermarkText="[Filter Name Search]">
                                            </cc1:TextBoxWatermarkExtender>
                                            &nbsp;<asp:TextBox ID="txtTransferEmpID" runat="server" CssClass="droplist" AccessKey="3" ToolTip="[Alt+3]" TabIndex="3"></asp:TextBox>
                ...
                <asp:GridView ID="gvViewApproved" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                          ...
                          <asp:TemplateField HeaderText="ERitemid" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblERItemID" runat="server" Text='<%#Eval("ERItemID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:GridView ID="gvEdit" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="100Px" HeaderText="Purpose">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPurpose" runat="server" Height="50" Text='<%# DataBinder.Eval(Container.DataItem,"Purpose") %>'
                                    TextMode="MultiLine" Width="200"></asp:TextBox><cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender6"
                                        runat="server" TargetControlID="txtPurpose" WatermarkCssClass="Watermarktxtbox"
                                        WatermarkText="[Enter Purpose Here..]">
                                    </cc1:TextBoxWatermarkExtender>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Spent On">
                            <ItemTemplate>
                                ...
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="txtSpentOn"
                                    TargetControlID="txtSpentOn" Format="dd/MM/yyyy">
                                </cc1:CalendarExtender>
                                 <cc1:FilteredTextBoxExtender FilterMode="ValidChars" FilterType="Numbers,Custom"
    ...
    <table id="tblTransfered" visible="false" runat="server" width="100%">
        <tr>
            <td class="pageheader">
                Transfered Amount To Accounts Dept
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id ="tblbtnapprove" runat="server" visible="false">
        <tr>
            <td>
                <asp:Button ID="btnapprovegm" runat="server" Text ="Approve" CssClass="btn btn-success" OnClick="btnapprovegm_Click" />
            </td>
        </tr>
    </table>
                ...
                <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Select">
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkSelectAll" Visible="true" runat="server" /></HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="RItem" HeaderText="PenaltyItem" />
                        ...
                        <asp:BoundField DataField="UnitRate" HeaderText="Penality Rate" />
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkReject"  ForeColor="Red" CommandName="Reject" CommandArgument='<%#Eval("ERItemID")%>'
        ...
        <tr>
            <td style="padding-left: 300Px">
                <asp:Button ID="btnApprove" ToolTip="Select the Items before Approve" CssClass="btn btn-success"
                    runat="server" Text="Approve" OnClick="btnApprove_Click" AccessKey="i"  />
                &nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <table id="tblShowRej" runat="server" width="100%" visible="false">
        ...
        <tr>
            <td>
                <asp:GridView ID="gvShowRej" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    OnRowCommand="gvShowRej_RowCommand" OnRowEditing="gvShowRej_RowEditing" CssClass="gridview">
                    <Columns>
                        <asp:TemplateField HeaderText="Select">
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkSelectAll" Visible="true" runat="server" /></HeaderTemplate>
                        ...
                        <asp:BoundField HeaderText="PenaltyItem" DataField="RItem" />
                        <asp:TemplateField HeaderText="Units of Measure">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlunits" DataSource='<%#GetAUDataSet() %>' Enabled="false"
                                    DataTextField="AU_Name" DataValueField="AU_Id" SelectedIndex='<%#GetAUIndex(Eval("AUID").ToString())%>'
                        ...
                        <asp:BoundField HeaderText="Penality Rate" DataField="UnitRate" />
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEdit" CommandName="Edit" CssClass="anchor__grd edit_grd " CommandArgument='<%#Eval("ERItemID")%>'
                                    runat="server">Edit</asp:LinkButton></ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
        ...
        <tr>
            <td style="padding-left: 300Px">
                <asp:Button ID="btnRApprove" ToolTip="Select the Items before Approve" CssClass="btn btn-success"
                    runat="server" Text="Approve" OnClick="btnApprove_Click" AccessKey="i"  />
            </td>
        </tr>
    </table>
            ...
            <td>
                <asp:TextBox ID="txtReason" runat="server" BorderColor="#CC6600" BorderStyle="Outset"
                    Height="70px" TextMode="MultiLine" Width="250px"></asp:TextBox><cc1:TextBoxWatermarkExtender
                        ID="TextBoxWatermarkExtender7" runat="server" TargetControlID="txtReason" WatermarkCssClass="Watermark"
                        WatermarkText="[Enter Reason To Reject!]">
                    </cc1:TextBoxWatermarkExtender>
            </td>
        </tr>
        <tr>
 ...
 <Triggers>
        ...
        <asp:PostBackTrigger ControlID="gvRemiItems" />                   
