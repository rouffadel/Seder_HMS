...
{
    public partial class LoanRecovery : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                if (Request.QueryString.Count > 0)
                {
                    ...
                    ds = SQLDBUtil.ExecuteDataset("SP_Th_LoansRecoveryApprovals_Insert_Update_Delete_VIEW_Paging_Select", parms);
                ...
                else
                {
                    ...
                    parms[0] = new SqlParameter("@mon", Convert.ToInt32(ddlmonth.SelectedValue));
                    parms[1] = new SqlParameter("@yr", Convert.ToInt32(ddlyear.SelectedItem.Text));
                    parms[2] = new SqlParameter("@CurrPage", objHrCommon.CurrentPage);
                    parms[3] = new SqlParameter("@PageSize", objHrCommon.PageSize);
                    parms[4] = new SqlParameter("@NrRecords", System.Data.SqlDbType.Int);
                    parms[4].Direction = ParameterDirection.Output;
                    ...
                    parms[6].Direction = ParameterDirection.ReturnValue;
                    ds = SQLDBUtil.ExecuteDataset("sh_salriesloanrecovery", parms);
                    objHrCommon.NoofRecords = (int)parms[4].Value;
                    objHrCommon.TotalPages = (int)parms[6].Value;
                }
