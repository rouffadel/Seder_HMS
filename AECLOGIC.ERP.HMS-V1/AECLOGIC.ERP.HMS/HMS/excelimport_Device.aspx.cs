...
{
    public partial class excelimport_Device : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Columns.Add("DevicesName", typeof(System.String));
                ...
                foreach (GridViewRow row in gvMapping.Rows)
                {
                    ...
                    if (chkitem.Checked == true)
                    {
                        ...
                        string desc = Convert.ToString(((Label)row.FindControl("lblpartdesc")).Text);
                        AttendanceDAC objAtt = new AttendanceDAC();
                        int Output = objAtt.HR_InsUpAttendanceDevice(0, dept, desc, stats, uid);
                        if (Output == 1)
