...
{
    public partial class FinalSettlement2 : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void startdate()
        {
            ...
            //stdt= DateTime.ParseExact(st, "MM/dd/yyyy", System.Globalization.CultureInfo.InvariantCulture);
            // eddt = DateTime.ParseExact(txtdate.Text, "MM/dd/yyyy", System.Globalization.CultureInfo.InvariantCulture);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    //this.Title = "Vacation Sattlement";
        ...
        public void calculations()
        {
            try
            {
                ...
                int EmpID = Convert.ToInt32(txtempid.Text.Trim());
                //  DateTime date = Convert.ToDateTime( txtDOS.Text.Trim ());
                // AttendanceDAC.HR_SavePaySLIP_CTH(EmpID, (txtDOS.Text.Trim());
        ...
        protected void gvWages_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    AlertMsg.MsgBox(Page, DelDesig.Message.ToString());
                }
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                AlertMsg.MsgBox(Page, AddDesignation.Message.ToString());
            }
        ...
        {
            startdate();
            Double A1 = 0, A2 = 0, A3 = 0, A4 = 0, A5 = 0, A6 = 0, A7 = 0, D1 = 0, D2 = 0, D3 = 0, D4 = 0, D5 = 0, D6 = 0, D7 = 0, Gratuityamt = 0;
            ...
            int id = AttendanceDAC.AddVacationSettlement(A1, A2, A3, A4, A5, A6, A7, D1, D2, D3, D4, D5, D6, D7, empid, Convert.ToInt32(Session["CompanyID"]), Remarks, Amt, "Vacation Settlement", month1, year1, A6Remarks, A7Remarks, D6Remarks, D7Remarks, Gratuityamt, "F");
            if (id == 1)
        ...
        //protected void btnCurrmntAtt_Click(object sender, EventArgs e)
        //{

        //}

        //protected void btnCurrmntAtt_Click1(object sender, EventArgs e)
        //{
        ...
        public DataView BindTransdetails(string TransId)
        {
            if (txtempid1.Text != string.Empty)
            {
                ...
                AttendanceDAC.HR_SavePaySLIP2(Convert.ToInt32(TransId), st, valofSync, "Final Settlement");
                ...
                if (!chkEnch.Checked)
                {
                    ...
                    //BindGridGratuity(objcommon, Convert.ToInt32(ddlworksite.SelectedValue));
                    ...
                    decimal gamt = 0;
                    DataSet dss = AttendanceDAC.GetGratuityDetails_Final(objcommon, CompanyID, Convert.ToInt32(ddlworksite.SelectedValue), txtempid1.Text.Trim(), accpost, Convert.ToInt32(ddlEmpDeAct.SelectedValue), edt);
                    ...
                    Total = Total + Convert.ToDouble(dstrans.Rows[0]["Amount"]) + Convert.ToDouble(gamt);
            ...
            {
                AlertMsg.MsgBox(Page, "Select Active Type");
                DataView dv = null;
                return dv;
            }
        ...
        public void BindGridGratuity(HRCommon objcommon, int WSID)
        {
            try
            {
                ...
                int accpost = 1;
                DataTable datatable2 = new DataTable();
                ds = AttendanceDAC.GetGratuityDetails_Final(objcommon, CompanyID, Convert.ToInt32(ddlworksite.SelectedValue), txtempid1.Text.Trim(), accpost, 1, Convert.ToDateTime("05/13/2016"));
            ...
            {
                // throw e;
                //AlertMsg.MsgBox(e.Message + mestBG);
            }
        ...
        public void BindCompanyList()
        {
            ...
            dscomp = AttendanceDAC.HR_GetCompanyList();
                ...
                foreach (DataListItem li in dtlvacation.Items)
                {
                    ...
                    foreach (GridViewRow row in gv.Rows)
                    {
                        ...
                        if (row.RowIndex == 9)
                        {
                            ...
                            //         p[3] = new SqlParameter("@CurrentPage", GrtPaging.CurrentPage);
                            //p[4] = new SqlParameter("@PageSize", GrtPaging.ShowRows);
