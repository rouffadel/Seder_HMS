<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="AECLOGIC.ERP.HMSV1.ViewEmpExitDetailsV1" Codebehind="ViewEmpExitDetails.aspx.cs"%>
                ...
                <td>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top">
                                &nbsp;&nbsp;
                                <asp:Label ID="lblFirstRemarks" runat="server" Font-Bold="True"></asp:Label>
                            </td>
                        </tr><tr><td></br></td></tr>
                        <tr>
                            <td  align="left" valign="top">
                            ...
                            <td align="left" valign="top">
                                &nbsp;&nbsp;
                                <asp:Label ID="lblSecondRemarks" runat="server" Font-Bold="True"></asp:Label>
                            </td>
                        </tr><tr><td></br></td></tr>
                        <tr>
                            <td  align="left" valign="top">
                            ...
                            <td align="left" valign="top">
                                &nbsp;&nbsp;
                                <asp:Label ID="lblThirdRemarks" runat="server" Font-Bold="True"></asp:Label>
                            </td>
                        </tr><tr><td></br></td></tr>
                        <tr>
                            <td  align="left" valign="top">
                            ...
                            <td align="left" valign="top">
                                &nbsp;&nbsp;
                                <asp:Label ID="lblGMRemarks" runat="server" Font-Bold="True"></asp:Label>
                            </td>
                        </tr><tr><td></br></td></tr>
                        <tr>
                            <td  align="left" valign="top">
                            ...
                            <td align="left" valign="top">
                                &nbsp;&nbsp;
                                <asp:Label ID="lblCFORemarks" runat="server" Font-Bold="True"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <asp:GridView ID="gdvIndent" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                        ...
                        <Columns>
                            <asp:TemplateField Visible="false" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:Label ID="lblItemID" runat="server" Text='<%#Bind("FEID")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left"
                             ...
                             <asp:TemplateField HeaderText="Exit From" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" >
                                <ItemTemplate>
                                    <asp:Label ID="lblAU1" runat="server" Text='<%#Bind("ExitFrom")%>' Width="100"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Exit Type" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" >
                                <ItemTemplate>
                                    <asp:Label ID="lblAU1" runat="server" Text='<%#Bind("ExitType")%>' Width="100"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Reason" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px">
                                <ItemTemplate>
