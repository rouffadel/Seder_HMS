<%@ Page Title="" Language="C#"   AutoEventWireup="True"
    CodeBehind="PTReports.aspx.cs" Inherits="AECLOGIC.ERP.HMS.PTReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <asp:UpdatePanel runat="server" ID="updpnl">
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td>
                        <cc1:Accordion ID="PTRptAccordion" runat="server" HeaderCssClass="accordionHeader"
                            HeaderSelectedCssClass="accordionHeaderSelected" ContentCssClass="accordionContent"
                            AutoSize="None" FadeTransitions="false" TransitionDuration="50" FramesPerSecond="40"
                            RequireOpenedPane="false" SuppressHeaderPostbacks="true">
                            <Panes>
                                <cc1:AccordionPane ID="PTRptAccordionPane1" runat="server" HeaderCssClass="accordionHeader"
    ...
    <asp:Panel ID="pnlESIRV" runat="server" Width="100%">
        <rsweb:ReportViewer ID="PTRV" runat="server" Font-Names="Verdana" Font-Size="8pt"
