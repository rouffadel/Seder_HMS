...
{
    public partial class Importexcel : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Columns.Add("Department_Name", typeof(System.String));
                dt.AcceptChanges();
                ...
                foreach (GridViewRow row in gvMapping.Rows)
                {
                    ...
                    if (chkitem.Checked == true)
                    {
                        ...
                        int Output = AttendanceDAC.InsUpdDepartment(0, dept, stats);
                        if (Output == 1)
