...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BIReport.aspx.cs" Inherits="AECLOGIC.ERP.HMS.BIReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
   <script type="text/javascript">
    ...
    <asp:Button ID="getReportButton" runat="server"  CssClass="btn btn-success" OnClick="getReportButton_Click" Text="Get Report" />  
