...
{
    public partial class Importexcel_Desi : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Columns.Add("Designations_Name", typeof(System.String));
                dt.AcceptChanges();
                ...
                foreach (GridViewRow row in gvMapping.Rows)
                {
                    ...
                    if (chkitem.Checked == true)
                    {
                        ...
                        int Output = AttendanceDAC.InsUpdDesigination(0, dept);
