<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAttendanceInactive.aspx.cs" Inherits="AECLOGIC.ERP.HMS.ViewAttendanceInactive" MasterPageFile="~/Templates/CommonMaster.master" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp;<asp:Button ID="btnPrint" ToolTip="Print Day Report" runat="server" CssClass="btn btn-primary"
                                                                Text="Print" OnClick="btnPrint_Click" Visible="false" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
			                                            ...
			                                            <asp:Button ID="btnMPrint" ToolTip="Print Month Report" runat="server" CssClass="btn btn-primary"
                                                            Text="Print" OnClick="btnMPrint_Click" Visible="false" />
                                                            &nbsp;
                                                        </td>
                                                        <td>
                        ...
                        <tr>
                            <td style="text-align: left" colspan="2">
                                ...
                                <uc1:Paging ID="EmpListPaging_Day" runat="server" />
                                <uc1:Paging ID="EmpListPaging" runat="server" />
                                <uc1:Paging ID="EmplistCalendar" runat="server" />
                            </td>
                        </tr>
                        <tr>
    ...
    <table id="tblAttStatus" runat="server" visible="false" width="100%">
        <tr>
            <td>
                ...
                <asp:GridView ID="gdWSRPT" runat="server" AutoGenerateColumns="False" Width="50%"
                    ShowFooter="True" EmptyDataText="No Records Found" HeaderStyle-CssClass="tableHead"
                    EmptyDataRowStyle-CssClass="EmptyRowData" AlternatingRowStyle-BorderColor="GhostWhite" Visible="false">
