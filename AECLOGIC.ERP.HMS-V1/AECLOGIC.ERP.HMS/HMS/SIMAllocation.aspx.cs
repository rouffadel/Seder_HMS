...
{
    public partial class SIMAllocation : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindGrid();
                FIllObject.FillDropDown(ref ddlVendors, "PM_GetPOVendors", "---All---");
            }
        }
        ...
        public void BindGrid()
        {
            ...
            DataSet ds = AttendanceDAC.GetEmpSimsList(0);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
        ...
        public void BindDetails(int ID)
        {
            ...
            tblNew.Visible = true;
            DataSet ds = AttendanceDAC.GetEmpSimsDetails(ID);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                txtEmpID.Text = ds.Tables[0].Rows[0]["EmpID"].ToString();
                txtMobileNO.Text = ds.Tables[0].Rows[0]["MobileNo"].ToString();
                txtSIMNO.Text = ds.Tables[0].Rows[0]["SIMNo"].ToString();
                txtAmountLt.Text = ds.Tables[0].Rows[0]["AmountLimit"].ToString();
                ddlVendors.SelectedValue = ds.Tables[0].Rows[0]["VendorID"].ToString();
            }
        }
