...
{
    public partial class MonthlyPaymentsProcessed : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        void EmployeBind(HRCommon objHrCommon)
        {
            try
            {
                ...
                DataSet dsBind = USP_Salaries_All_3(objHrCommon, startdate, EndDate, EmpID);
        ...
        private DataSet USP_Salaries_All_3(HRCommon objHrCommon,DateTime startdate,DateTime enddate,int Empid)
        {
            DataSet ds = null;
            try
            {
                ...
                ds = SQLDBUtil.ExecuteDataset("USP_Salaries_All_3_1", sqlParams);
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (Convert.ToInt32(ddlMonth.SelectedValue) != 0 & Convert.ToInt32(ddlYear.SelectedValue) > 0)
                {
                    ...
                    DateTime startdate = CodeUtilHMS.ConvertToDate(stDate, CodeUtilHMS.DateFormat.DayMonthYear);
                    DateTime EndDate = CodeUtilHMS.ConvertToDate(enddate, CodeUtilHMS.DateFormat.DayMonthYear);
                    USP_Salaries_All_Save(objHrCommon, startdate, EndDate, txtEmpID.Text.Trim());
        ...
        private DataSet USP_Salaries_All_Save(HRCommon objHrCommon, DateTime startdate, DateTime enddate, string Empid)
        {
            DataSet ds = null;
            try
            {
                ...
                sqlParams[3] = new SqlParameter("@WSID", objHrCommon.SiteID);

                SQLDBUtil.ExecuteNonQuery("USP_Salaries_All_Save", sqlParams);
