<%@ Page Language="C#"   AutoEventWireup="True" ValidateRequest="false"
    CodeBehind="Appointment.aspx.cs" Inherits="AECLOGIC.ERP.HMS.Appointment" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ChkAppDetails(id) {
            alert('Employee details are insufficient');
            location.href = "../HMS/CreateEmployee.aspx?id=" + id;
        }
    </script>
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <asp:Button ID="Button3" runat="server" CssClass="btn btn-warning" OnClick="Button2_Click"
                    Text="Back" />
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            ...
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" CssClass="btn btn-success"
                                Width="100px" />
                            <asp:Button ID="Button2" runat="server" CssClass="btn btn-warning" OnClick="Button2_Click"
                                Text="Back" />
                        </td>
                        <td>
                        </td>
