...
namespace AECLOGIC.ERP.HMS
{
    ...
    public partial class OPtionNew : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception) { //clsErrorLog.HMSEventLog(ex, "ReqfromOMS", "Page_Load", "001");
            }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                parms[1] = new SqlParameter("@OptionID", hdOptionID.Value);

                parms[2] = new SqlParameter("@Purpose", txtPurpose1.Text.Trim());

                parms[3] = new SqlParameter("@Value", txtValue.Text.Trim());

                parms[4] = new SqlParameter("@UpdateBy", ddlUpdateBy.SelectedValue.Trim()); DateTime dtUpdatedOn = ConverttoDateFormat(txtUpdatedOn.Text.Trim(), DateFormat.ddMMMyyyy);

                parms[5] = new SqlParameter("@UpdatedOn", dtUpdatedOn);

                    parms[6] = new SqlParameter("@IsActive", 0);

                    parms[7] = new SqlParameter("@IsModify", 0);

                parms[8] = new SqlParameter("@dependencyDesc", txtdependencyDesc.Text.Trim());

                parms[9] = new SqlParameter("ReturnValue", System.Data.SqlDbType.Int); parms[9].Direction = ParameterDirection.ReturnValue;

                int Output = SqlHelper.ExecuteNonQuery("SP_T_G_Options_Insert_Update_Delete_VIEW_Paging_Select", parms);
               ...
               // clsErrorLog.HMSEventLog(ex, "ReqfromOMS", "btnSubmit_Click", "002");
            }
        ...
        protected void gvEV_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                else if (e.CommandName == "Del")
                {
                    ...
                    parms[0] = new SqlParameter("@OptionID", ID);
        ...
        public void clear() { hdOptionID.Value = "0"; txtPurpose1.Text = ""; txtValue.Text = ""; ddlUpdateBy.SelectedValue = "0"; txtUpdatedOn.Text = "";  txtdependencyDesc.Text = ""; }
        ...
        void GridBind(HRCommon objHrCommon)
        {
            ...
            try
            {
                ...
                objHrCommon.CurrentPage = EmpListPaging.CurrentPage; SqlParameter[] parms = new SqlParameter[9];
                ...
                {
                    psid = Convert.ToInt32(txtpurpose_hid.Value == "" ? "0" : txtpurpose_hid.Value);

                }
                parms[5] = new SqlParameter("@psid", psid);

                parms[6] = new SqlParameter("@txtval", txtval.Text.Trim());

                int prcsid = 0;
                if (txtprcs.Text.Trim() != "")
                {
                    prcsid = Convert.ToInt32(txtprocessnamr_hid.Value == "" ? "0" : txtprocessnamr_hid.Value);

                }
                parms[7] = new SqlParameter("@prnmid", prcsid);
                int aspx = 0;
                if (txtaspx.Text.Trim() != "")
                {
                    aspx = Convert.ToInt32(txtaspx_hid.Value == "" ? "0" : txtaspx_hid.Value);

                }
                parms[8] = new SqlParameter("@aspx", aspx);
                DataSet ds = SqlHelper.ExecuteDataset("SP_T_G_Options_Insert_Update_Delete_VIEW_Paging_Select", parms);
               ...
               // clsErrorLog.HMSEventLog(ex, "ReqfromOMS", "GridBind", "004");
            }
        ...
        public static DataSet SearchcpcID(String SearchKey)
        {
            try
            {
                SqlParameter[] param = new SqlParameter[1];
                param[0] = new SqlParameter("@search", SearchKey);
                DataSet ds = SqlHelper.ExecuteDataset("HMS_Option_Googlesearch", param);
                return ds;
            }
        ...
        public static string[] GetCompletionList(string prefixText, int count, string contextKey)
        {
            ...
            DataSet ds = SearchcpcID(prefixText);
        ...
        public static DataSet Searchcprcessname(String SearchKey)
        {
            try
            {
                SqlParameter[] param = new SqlParameter[1];
                param[0] = new SqlParameter("@search", SearchKey);
                DataSet ds = SqlHelper.ExecuteDataset("HMS_Option_Googlesearch_process", param);
                return ds;
            }
            catch (Exception e) { throw e; }
        }
        [System.Web.Services.WebMethodAttribute(), System.Web.Script.Services.ScriptMethodAttribute()]
        public static string[] txtprcsname(string prefixText, int count, string contextKey)
        {


            DataSet ds = Searchcprcessname(prefixText);
        ...
        public static DataSet Searchcaspx(String SearchKey)
        {
            try
            {
                SqlParameter[] param = new SqlParameter[1];
                param[0] = new SqlParameter("@search", SearchKey);
                DataSet ds = SqlHelper.ExecuteDataset("HMS_Option_Googlesearch_Reference", param);
                return ds;
            }
            catch (Exception e) { throw e; }
        }
        [System.Web.Services.WebMethodAttribute(), System.Web.Script.Services.ScriptMethodAttribute()]
        public static string[] txtaspxservice(string prefixText, int count, string contextKey)
        {


            DataSet ds = Searchcaspx(prefixText);
        ...
        public void BindDetails(int ID)
        {
            try
            {
                ...
                parms[1] = new SqlParameter("@dependencyDesc", 1);
                ...
                if (ds != null && ds.Tables.Count != 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    EditView.Visible = false; NewView.Visible = true;
                    hdOptionID.Value = ds.Tables[0].Rows[0]["OptionID"].ToString(); 
                    txtPurpose1.Text = ds.Tables[0].Rows[0]["Purpose"].ToString(); 
                    txtValue.Text = ds.Tables[0].Rows[0]["Value"].ToString(); 
                    ddlUpdateBy.SelectedValue = ds.Tables[0].Rows[0]["UpdateBy"].ToString();
                    txtUpdatedOn.Text = ds.Tables[0].Rows[0]["UpdatedOn"].ToString();

                  

                    txtdependencyDesc.Text = ds.Tables[0].Rows[0]["dependencyDesc"].ToString();
                ...
                //clsErrorLog.HMSEventLog(ex, "ReqfromOMS", "BindDetails", "005"); 
            }
        ...
        private void bindddl()
        {
            ...
            FIllObject.FillDropDown(ref ddlUpdateBy, "T_G_Options_ddl", parms1);
