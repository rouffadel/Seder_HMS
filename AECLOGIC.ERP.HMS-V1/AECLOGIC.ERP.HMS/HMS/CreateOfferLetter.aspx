<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="CreateOfferLetter.aspx.cs"
    ValidateRequest="false" Inherits="AECLOGIC.ERP.HMS.CreateAplicantOfferLetter" Title="Create Offer Letter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <asp:Button ID="Button2" CssClass="btn btn-primary" runat="server" Text="Back" OnClick="Button2_Click" />
            </td>
        </tr>
        <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        ...
                        <td style="text-align: right; vertical-align: top;">
                            <table>
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        <asp:FileUpload ID="fupdempimag" runat="server" Height="24px" Width="315px" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" style="vertical-align: top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;">
                                        ...
                                        <cc1:CalendarExtender TargetControlID="txtDOJ" PopupButtonID="txtDOJ" ID="CalendarExtender1"
                            ...
                            <br />
                            Help: [designation] Designation; [salary] : Salary; [doj] : Date Of Joining
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <table id="TABLEmails1" runat="server" align="center" border="1" style="background-color: white"
                                    ...
                                    <td align="left">
                                        <table id="TopToolBar" align="left" cellpadding="0" cellspacing="3" class="raiseme">
                                            <tr>
                                                ...
                                                <td>
                                                    <img align="middle" src="Images/spacer.gif" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="cbtn" onclick="cmdExec('superscript')" onmousedown="button_down(this);"
                                                        onmouseout="button_out(this);" onmouseover="button_over(this);" onmouseup="button_up(this);">
                                                        <img align="middle" alt="Superscript" hspace="1" src="Images/superscript.gif" vspace="0" /></div>
                                                </td>
                                                <td>
                                                ...
                                                <td valign="middle">
                                                    <input id="checkbox2" name="checkbox2" onclick="setMode(this.checked)" type="checkbox" />
                                                </td>
                                                <td nowrap="nowrap" style="font: 8pt verdana,arial,sans-serif" valign="middle">
                                                    Edit HTML
                                                </td>
                                                <td style="width: 5px">
                                                    <img align="middle" src="Images/leader.gif" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="cbtn" onclick="cmdExec('insertorderedlist')" onmousedown="button_down(this);"
                                                        onmouseout="button_out(this);" onmouseover="button_over(this);" onmouseup="button_up(this);">
                                                        <img align="middle" alt="Ordered List" hspace="2" src="Images/numlist.GIF" vspace="0" /></div>
                                                </td>
                                                <td>
                                                    <div class="cbtn" onclick="cmdExec('insertunorderedlist')" onmousedown="button_down(this);"
                                                        onmouseout="button_out(this);" onmouseover="button_over(this);" onmouseup="button_up(this);">
                                                        <img align="middle" alt="Unordered List" hspace="2" src="Images/bullist.GIF" vspace="0" /></div>
                                                </td>
                                                <td>
                                                    <div class="cbtn" onclick="cmdExec('outdent')" onmousedown="button_down(this);" onmouseout="button_out(this);"
                                                        onmouseover="button_over(this);" onmouseup="button_up(this);">
                                                        <img align="middle" alt="Decrease Indent" hspace="2" src="Images/DeIndent.GIF" vspace="0" /></div>
                                                </td>
                                                <td>
                                                    <div class="cbtn" onclick="cmdExec('indent')" onmousedown="button_down(this);" onmouseout="button_out(this);"
                                                        onmouseover="button_over(this);" onmouseup="button_up(this);">
                                                        <img align="middle" alt="Increase Indent" hspace="2" src="Images/inindent.GIF" vspace="0" /></div>
                                                </td>
                                                <td>
                                                    <img align="middle" src="Images/spacer.gif" />
                                                </td>
                                ...
                                <tr>
                                    <td>
                                        <div id="TextEditor" contenteditable="true" style="overflow: auto; width: 100%; height: auto;"
                                            language="javascript" onclick="return TextEditor_onclick()" onkeyup="return TextEditor_edit()"
                                            runat="server">
                                            &nbsp;&nbsp;<br />
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="height: 0px">
                                        ...
                                        key to Next Paragraph;<object classid="clsid:5220cb21-c88d-11cf-b347-00aa00a28331"></object><object
                                            id="dlgHelper" classid="clsid:3050f819-98b5-11cf-bb82-00aa00bdce0b" height="0px"
                                            width="0px"></object><object id="cDialog" classid="CLSID:F9043C85-F6F2-101A-A3C9-08002B2F49FB"
                                                codebase="http://activex.microsoft.com/controls/vb5/comdlg32.cab" height="0px"
                                                width="0px"><param name="_ExtentX" value="847"><param name="_ExtentY" value="847"><param
                                                    name="_Version" value="393216"><param name="CancelError" value="0"><param name="Color"
                                                        value="0"><param name="Copies" value="1"><param name="DefaultExt" value=""><param
                                                            name="DialogTitle" value=""><param name="FileName" value=""><param name="Filter"
                                                                value=""><param name="FilterIndex" value="0"><param name="Flags" value="0"><param
                                                                    name="FontBold" value="0"><param name="FontItalic" value="0"><param name="FontName"
                                                                        value=""><param name="FontSize" value="8"><param name="FontStrikeThru" value="0"><param
                                                                            name="FontUnderLine" value="0"><param name="FromPage" value="0"><param name="HelpCommand"
                                                                                value="0"><param name="HelpContext" value="0"><param name="HelpFile" value=""><param
                                                                                    name="HelpKey" value=""><param name="InitDir" value=""><param name="Max" value="0"><param
                                                                                        name="Min" value="0"><param name="MaxFileSize" value="260"><param name="PrinterDefault"
                                                                                            value="1"><param name="ToPage" value="0"><param name="Orientation" value="1"></object>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <strong>For
                                <asp:Label ID="Label1" runat="server" Text="<%$ AppSettings:Company %>"></asp:Label></strong>
                        </td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top; line-height: 50px">
                        </td>
                        <td>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" OnClientClick="javascript:return ValidOffer();"
