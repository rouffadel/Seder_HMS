<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbsentPenalities.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master"
    Inherits="AECLOGIC.ERP.HMS.AbsentPenalities" %>
                            ...
                            <td align="left">Designation:-
                                ...
                                &nbsp;EmpID<asp:TextBox ID="txtEmpID" Width="50Px" Height="20px" runat="server" AccessKey="4" ToolTip="[Alt+4]"
                                    TabIndex="4" onkeypress="javascript:return isNumber(event)"></asp:TextBox>
                                                  ...
                                                  <tr>
                                                      <td colspan="6">
                                                          <asp:Button ID="btnsearch" runat="server" Text="Search" CssClass="savebutton" Width="40px"
                                                              OnClick="btnsearch_Click" />
                                                          <asp:Button ID="btnSync" runat="server" Text="Sync" CssClass="savebutton" Width="40px"
                                                              OnClick="btnSync_Click" />
                                                          <asp:Button ID="btnTransferAcc" CssClass="savebutton" ToolTip="Transfer To Accounts Dept."
                                                              runat="server" Text="Approve" OnClick="btnTransferAcc_Click" />
                                                      </td>
                        </tr>
                        <tr>
                            <td></td>
                ...
                <asp:GridView ID="gvViewApproved" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <%-- <asp:TemplateField HeaderText="Limited">
                            <ItemTemplate>
                                <asp:Label ID="lblLimited" runat="server" Text='<%#Eval("Limited") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
