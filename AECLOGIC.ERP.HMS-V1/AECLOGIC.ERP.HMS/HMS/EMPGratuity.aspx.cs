...
{
    public partial class EMPGratuity : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        public int GetParentMenuId()
        {
           ...
           DataSet ds = AttendanceDAC.GetAllowed(RoleId, ModuleId, URL);
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                gvEMPGratuity.Columns[2].Visible = Editable = Convert.ToBoolean(ds.Tables[0].Rows[0]["Editable"].ToString());
            }
            return MenuId;
        }
        ...
        void BindGrid()
        {
            try
            {
              ...
              DataSet  ds = PayRollMgr.GratuityListByPaging(EmpID, objHrCommon);
                if (ds != null && ds.Tables.Count != 0 && ds.Tables[0].Rows.Count > 0)
                {
                    gvEMPGratuity.DataSource = ds;
                    gvEMPGratuity.DataBind();
                }
                else
