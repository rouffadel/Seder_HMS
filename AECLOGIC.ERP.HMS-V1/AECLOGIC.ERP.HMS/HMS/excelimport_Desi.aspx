<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="excelimport_Desi.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master"
    Inherits="AECLOGIC.ERP.HMS.Importexcel_Desi"  %>
    ...
    <table cellpadding="1" cellspacing="1" width="100%">
        ...
        <tr>
            <td colspan="4" valign="top">
                ...
                <asp:Button ID="Button1" runat="server" Text="Import" OnClick="btnImport_Click" CssClass="btn btn-success " AccessKey="i" ToolTip="[Alt+i OR Alt+i+Enter]"
                    Width="61px" />
                <asp:HyperLink ID="hyperlink1" runat="server" Text="Download a sample Excel format..." CssClass="btn btn-primary" Target="_blank"
                    NavigateUrl="~/Reports/Desginations_Sample_Format.xls"></asp:HyperLink>
            ...
            <td colspan="4">
                <asp:GridView ID="gvMapping" runat="server"  CssClass="gridview" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField >
                        <HeaderTemplate> <span style="font-size:10px; font-family:Verdana"> Import Desginations from Excel...</span>  </HeaderTemplate>
                    
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblparti" Text='<% #Eval("DesignationsName") %>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
        ...
        <tr>
            <td>
                ...
                <asp:LinkButton ID="lnkError" runat="server" Text="Click here to download"  CssClass="btn btn-success" Visible="false"
        ...
        <tr>
            <td>
                ...
                <asp:LinkButton ID="lnkTSError" runat="server" Text="Click here to download"  CssClass="btn btn-success"  Visible="false"
                    OnClick="lnkTSError_Click"></asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="btnback" runat="server" Text="Back"  CssClass="btn btn-primary "  OnClick="btnback_Click" Visible="false" />
            </td>
        </tr>
    </table>
 </ContentTemplate>
