<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyPaymentsApproved.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master"
    Inherits="AECLOGIC.ERP.HMS.MonthlyPaymentsApproved" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvPaySlip" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Empid" DataField="Empid" Visible="false"></asp:BoundField>
                                                            <asp:BoundField HeaderText="EmpName" DataField="Name"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Month" DataField="Month" Visible="false"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Year" DataField="Year" Visible="false"></asp:BoundField>
                                                            <asp:BoundField HeaderText="MonthDays" DataField="MonthDays" Visible="false"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Payabledays" DataField="Payabledays"></asp:BoundField>
                                                            <asp:BoundField HeaderText="PayStartDt" DataField="PayStartDt"></asp:BoundField>
                                                            <asp:BoundField HeaderText="PayEndDt" DataField="PayEndDt"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Basicsalary" DataField="Basic"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Sum CTC" DataField="SumCTC"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Sum NCTC" DataField="SumNCTC"></asp:BoundField>
                                                            <asp:BoundField HeaderText="SUM Deduction" DataField="SUMDeduction"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Penalty" DataField="Penalty"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Emp Penality" DataField="EmpPenality"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Mobile" DataField="Mobile"></asp:BoundField>
                                                            <asp:BoundField HeaderText="OT" DataField="OT"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Loan" DataField="Loan"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Salary" DataField="Salary"></asp:BoundField>
                                                        </Columns>
