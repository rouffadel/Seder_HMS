<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeavesAvailableDetails.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master" Inherits="AECLOGIC.ERP.HMS.HMS.LeavesAvailableDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
        <ContentTemplate>
            ...
            <table style="width: 98%;">
                <tr>
                    <td colspan="3">
                        <asp:DropDownList ID="ddlYear" runat="server" TabIndex="3" AccessKey="y" ToolTip="[Alt+y]" CssClass="droplist"
                            Width="100px" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged" AutoPostBack="true" Visible="false">
                        </asp:DropDownList>
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td style="width: 13%;">
                        ...
                        <asp:LinkButton ID="lblLVRD" runat="server" Font-Bold="true" ForeColor="Navy" OnClick="lblLVRD_Click"></asp:LinkButton>
                                    ...
                                    <asp:GridView ID="GVVoucherDetails" runat="server" AlternatingRowStyle-BackColor="GhostWhite"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Date">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkdate" runat="server" Font-Bold="true" ForeColor="Blue" Text='<%#Bind("ActionDate")%>'
                                                        CommandName="date" CommandArgument='<%#Bind("ActionDate")%>'></asp:LinkButton>
                                                    <asp:HiddenField ID="HidMonth" runat="server" Value='<%#Eval("ActionMonth") %>' />
                                                    <asp:HiddenField ID="Hidyear" runat="server" Value='<%#Eval("ActionYear") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <table id="tbllvrd" runat="server" visible="false">
                <tr>
                    <td>
                        <asp:GridView ID="gvGranted" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Apprvd By" DataField="OkBy" />
