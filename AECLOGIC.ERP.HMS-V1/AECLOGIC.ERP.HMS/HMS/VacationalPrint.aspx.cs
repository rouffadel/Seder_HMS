...
{
    public partial class VacationalPrintV1 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Checked)
                lblHeader.Text = "Vacation Settlement Voucher";
            else
                lblHeader.Text = "Final Settlement Voucher";
        }
        ...
        protected void QtyChanged(object sender, EventArgs e)
        {
            ...
            foreach (DataListItem li in dtlvacation.Items)
            {
                ...
                foreach (GridViewRow row in gv.Rows)
                {
                    ...
                    if (!Checked)
                    {
                        TextBox ta = (TextBox)row.FindControl("txtA11");
                        if (ta.Text=="A")
                        {
        ...
        public DataView BindTransdetails(string Id)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                dt.Columns.Add("LoanProof", typeof(string));

                string strA2Label = string.Empty;
                strA2Label = getBetween(ds.Tables[0].Rows[0]["A2Label"].ToString().Replace("&nbsp;", ""), ")=", "LVRD");

               // if (ds.Tables[0].Rows[0]["A1"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A1"])!=0)
                dt.Rows.Add("A",ds.Tables[0].Rows[0]["A1Remarks"].ToString(), "A1: Salary For the Current Month", ds.Tables[0].Rows[0]["A1"].ToString(), ds.Tables[0].Rows[0]["A1Label"].ToString().Replace("&nbsp;", ""));
               // if (ds.Tables[0].Rows[0]["A2"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A2"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A2Remarks"].ToString(), "A2: Encashment of AL(EAL)", ds.Tables[0].Rows[0]["A2"].ToString(), "Accrued AL Days: "+ strA2Label);
                if (ds.Tables[0].Rows[0]["A3"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A3"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A3Remarks"].ToString(),"A3: HRA for LOP ", ds.Tables[0].Rows[0]["A3"].ToString(), ds.Tables[0].Rows[0]["A3Label"].ToString().Replace("&nbsp;", ""));
                if (ds.Tables[0].Rows[0]["A4"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A4"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A4Remarks"].ToString(), "A4: Over-Time Amount", ds.Tables[0].Rows[0]["A4"].ToString(), ds.Tables[0].Rows[0]["A4Label"].ToString().Replace("&nbsp;", ""));
                if (ds.Tables[0].Rows[0]["A5"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A5"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A5Remarks"].ToString(), "A5: Air Ticket Reimbursement", ds.Tables[0].Rows[0]["A5"].ToString(), ds.Tables[0].Rows[0]["A5Label"].ToString().Replace("&nbsp;", ""));
                else
                    dt.Rows.Add("A", "Provided by the Company", "A5: Air Ticket Reimbursement", ds.Tables[0].Rows[0]["A5"].ToString());

                if (ds.Tables[0].Rows[0]["A6"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A6"]) != 0)
                {
                    if (Checked)
                        dt.Rows.Add("A", ds.Tables[0].Rows[0]["A6Remarks"].ToString(), "A6: Exit VISA", ds.Tables[0].Rows[0]["A6"].ToString());
                    else
                        dt.Rows.Add("A", ds.Tables[0].Rows[0]["A6Remarks"].ToString(), "A6: Exit Entry VISA Reimbursement", ds.Tables[0].Rows[0]["A6"].ToString());
                }
                else
                {
                    if (Checked)
                        dt.Rows.Add("A", "Provided by the Company", "A6: Exit VISA", ds.Tables[0].Rows[0]["A6"].ToString());
                    else
                        dt.Rows.Add("A", "Provided by the Company", "A6: Exit Entry VISA Reimbursement", ds.Tables[0].Rows[0]["A6"].ToString());
                }
                if (ds.Tables[0].Rows[0]["A7"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A7"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A7Remarks"].ToString(), "A7: AL Based On Previous Basic", ds.Tables[0].Rows[0]["A7"].ToString());
                if (ds.Tables[0].Rows[0]["A8"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["A8"]) != 0)
                    dt.Rows.Add("A", ds.Tables[0].Rows[0]["A8Remarks"].ToString(), "A8: ", ds.Tables[0].Rows[0]["A8"].ToString());
                //TotSum = Convert.ToDecimal(ds.Tables[0].Rows[0]["A1"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["A2"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["A3"])
                //    + Convert.ToDecimal(ds.Tables[0].Rows[0]["A4"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["A5"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["A6"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["A7"]);
                if (Checked)
                {
                    dt.Rows.Add("A", "","Gratuity ", ds.Tables[0].Rows[0]["gratuity"].ToString(), ds.Tables[0].Rows[0]["GratuityRemarks"].ToString());
                    TotSum = TotSum + Convert.ToDecimal(ds.Tables[0].Rows[0]["gratuity"]);
                }
                //TotDud = Convert.ToDecimal(ds.Tables[0].Rows[0]["D1"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["D2"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["D3"])
                //    + Convert.ToDecimal(ds.Tables[0].Rows[0]["D4"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["D5"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["D6"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["D7"]);
                if (ds.Tables[0].Rows[0]["D1"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D1"]) != 0)
                    dt.Rows.Add("D",ds.Tables[0].Rows[0]["D1Remarks"].ToString(), "D1: Transport & Food ", ds.Tables[0].Rows[0]["D1"].ToString(), ds.Tables[0].Rows[0]["D1Label"].ToString().Replace("&nbsp;", ""));
                if (ds.Tables[0].Rows[0]["D2"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D2"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D2Remarks"].ToString(), "D2: Other Manual Deductions ", "0", "");
                if (ds.Tables[0].Rows[0]["D3"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D3"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D3Remarks"].ToString(), "D3: OutStanding  Advances", ds.Tables[0].Rows[0]["D3"].ToString(), ds.Tables[0].Rows[0]["D3Label"].ToString().Replace("&nbsp;", ""), "", ds.Tables[0].Rows[0]["LoanProof"].ToString());
                if (ds.Tables[0].Rows[0]["D4"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D4"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D4Remarks"].ToString(), "D4: Absent Penalty ", ds.Tables[0].Rows[0]["D4"].ToString(), ds.Tables[0].Rows[0]["D4Label"].ToString().Replace("&nbsp;", ""));
                if (ds.Tables[0].Rows[0]["D5"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D5"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D5Remarks"].ToString(), "D5: Expat ", 0, exptdetails, btnMeds);
                if (ds.Tables[0].Rows[0]["D6"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D6"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D6Remarks"].ToString(), "D6:", ds.Tables[0].Rows[0]["D6"].ToString());
                if (ds.Tables[0].Rows[0]["D7"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["D7"]) != 0)
                    dt.Rows.Add("D", ds.Tables[0].Rows[0]["D7Remarks"].ToString(), "D7:", ds.Tables[0].Rows[0]["D7"].ToString());
                if (ds.Tables[0].Rows[0]["AdjAmt"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["AdjAmt"]) != 0)
                    dt.Rows.Add("D", "","AdjAmt:", ds.Tables[0].Rows[0]["AdjAmt"].ToString());
                if (ds.Tables[0].Rows[0]["EmpPen"].ToString() != null && Convert.ToDecimal(ds.Tables[0].Rows[0]["EmpPen"]) != 0)
                    dt.Rows.Add("D", "","Emp Penalities:", ds.Tables[0].Rows[0]["EmpPen"].ToString());
                //TotDud = TotDud + Convert.ToDecimal(ds.Tables[0].Rows[0]["AdjAmt"]) + Convert.ToDecimal(ds.Tables[0].Rows[0]["EmpPen"]);
                //TotSum = TotSum - TotDud;
                dt.Rows.Add("C", "","Remarks", "");
                ...
                //if (TotSum < 0)
                //    TotSum = 0;
                //Label lblval = (Label)GVVacation.FooterRow.FindControl("lblvalue");
                //lblval.Text = Math.Round(TotSum).ToString("#,#", CultureInfo.InvariantCulture) + " SAR";
            }
            DataView dv = dt.DefaultView;
           
            return dv;
        }
        public bool VDocVisible(string Ext)
        {
            if (Ext != "")
                return true;
            else
        ...
        public string DocNavigateUrl(string ProofID)
        {
            string ReturnVal = "";
            ReturnVal = "~/EmpVacation/" + ProofID;
