...
namespace AECLOGIC.ERP.HMS
{
    ...
    public partial class EmployeeExitReasons : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try { string id = AECLOGIC.ERP.COMMON.clSession.cmnUserId.ToString(); }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                parms[2] = new SqlParameter("@ReasonName", txtReasonName.Text.Trim());

                parms[3] = new SqlParameter("@EId", ddlEId.SelectedValue.Trim());

                parms[4] = new SqlParameter("ReturnValue", System.Data.SqlDbType.Int); parms[4].Direction = ParameterDirection.ReturnValue;

                int Output = SqlHelper.ExecuteNonQuery("SP_th_EmployeeExitReasons_Insert_Update_Delete_VIEW_Paging_Select", parms);
        ...
        public void clear() { hdRid.Value = "0"; txtReasonName.Text = ""; ddlEId.SelectedValue = "0"; }
        ...
        void GridBind(HRCommon objHrCommon)
        {
            ...
            try
            {
                ...
                objHrCommon.CurrentPage = EmpListPaging.CurrentPage; SqlParameter[] parms = new SqlParameter[8];
                ...
                parms[4].Direction = ParameterDirection.ReturnValue; int hdReasonName = 0; if (txtSReasonName.Text.Trim() != "") { hdReasonName = Convert.ToInt32(hdSReasonName.Value == "" ? "0" : hdSReasonName.Value); } if (hdReasonName != 0) parms[6] = new SqlParameter("@ReasonName", hdReasonName); else parms[6] = new SqlParameter("@ReasonName", SqlDbType.Int);

                int hdEId = 0; if (txtSEId.Text.Trim() != "")// { hdEId = Convert.ToInt32(hdSEId.Value == "" ? "0" : hdSEId.Value); } if (hdEId != 0)
                    parms[7] = new SqlParameter("@EId", txtSEId.Text); 
                else parms[7] = new SqlParameter("@EId", SqlDbType.Int);


                DataSet ds = SqlHelper.ExecuteDataset("SP_th_EmployeeExitReasons_Insert_Update_Delete_VIEW_Paging_Select", parms);
        ...
        public int GetParentMenuId()
        {
            ...
            if (AECLOGIC.ERP.COMMON.clSession.cmnUserId == null) { Response.Redirect("Logon.aspx"); }
        ...
        public void BindDetails(int ID)
        {
            try
            {
                ...
                parms[1] = new SqlParameter("@EId", 1);
                ...
                if (ds != null && ds.Tables.Count != 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    EditView.Visible = false; NewView.Visible = true; hdRid.Value = ds.Tables[0].Rows[0]["Rid"].ToString(); txtReasonName.Text = ds.Tables[0].Rows[0]["ReasonName"].ToString(); ddlEId.SelectedValue = ds.Tables[0].Rows[0]["EId"].ToString();
        ...
        public static DataSet SearchEId(String SearchKey)
        {
            try
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset("th_EmployeeExitReasons_Search", param);
        ...
        public static string[] GetCompletionEId(string prefixText, int count, string contextKey)
        {

            DataSet ds = SearchEId(prefixText);
        ...
        private void bindddl()
        {
            ...
            FIllObject.FillDropDown(ref ddlEId, "th_EmployeeExitReasons_ddl", parms1);
