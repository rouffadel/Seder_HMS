<%@ Page Title="" Language="C#"   AutoEventWireup="True"
    CodeBehind="ExceRptAttendance.aspx.cs" Inherits="AECLOGIC.ERP.HMS.ExceRptAttendance" %>
                        ...
                        <cc1:AccordionPane ID="AccordionPane1" runat="server" HeaderCssClass="accordionHeader"
                            ...
                            <Content>
                                <table>
                                    <tr>
                                        <td align="left">
                                            <asp:RadioButtonList ID="rblst" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                                                TabIndex="1" AccessKey="1" ToolTip="[Alt+1]">
                                                <asp:ListItem Text="Min WHS" Value="1" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Max WHS" Value="2"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender5" runat="server" TargetControlID="txtSearchWorksite"
                                             ...
                                             <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters="" Enabled="True"
                                            ...
                                            </strong>&nbsp;&nbsp; <strong>EmpID&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtEmpID" Width="50"
                                                runat="server" TabIndex="4" AccessKey="3" ToolTip="[Alt+3]" onkeypress="javascript:return isNumber(event)"></asp:TextBox>
                                                ...
                                                <asp:DropDownList ID="ddlminhrs" runat="server" CssClass="droplist" TabIndex="5"
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            &nbsp;&nbsp;<asp:TextBox ID="txtDay" runat="server" TabIndex="6" AccessKey="t" ToolTip="[Alt+t OR Alt+t+Enter]"></asp:TextBox>
                                            &nbsp;&nbsp;
                                            ...
                                            <asp:Button ID="btnDaySearch" ToolTip="Generate Day Report" runat="server" CssClass="savebutton"
                                                OnClick="btnDaySearch_Click" Text="Day Report" TabIndex="7" AccessKey="i" />
                                            &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<asp:Label ID="lblMonth" runat="server" Text="Month Wise"></asp:Label>
                                            &nbsp;&nbsp;
                                            <asp:DropDownList ID="ddlMonth" runat="server" AutoPostBack="true" AccessKey="5"
                                                ToolTip="[Alt+5]" TabIndex="8" CssClass="droplist">
                                            ...
                                            <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true" CssClass="droplist"
                                                TabIndex="9" AccessKey="6" ToolTip="[Alt+6]">
                                            </asp:DropDownList>
                                            &nbsp;&nbsp;
                                            <asp:Button ID="btnMonthReport" ToolTip="Generate Month Report" runat="server" CssClass="savebutton"
                                                OnClick="btnMonthReport_Click" Text="Month Report" TabIndex="10" />
                                            &nbsp;&nbsp; &nbsp;
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table>
                                ...
                                <td>
                                    <asp:GridView ID="grdAllEmployees" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NoofLates" HeaderText="No of Late(s)/Over Time" />
                                            <asp:TemplateField>
                                                <ItemTemplate>
                            ...
                            <tr>
                                <td colspan="2" style="height: 29px">
                                    <uc1:Paging ID="ExceRptAttendancePaging" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td>
