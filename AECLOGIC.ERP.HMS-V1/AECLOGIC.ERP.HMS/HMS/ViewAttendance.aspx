<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="ViewAttendance.aspx.cs" MasterPageFile="~/Templates/CommonMaster.master"
    Inherits="AECLOGIC.ERP.HMSV1.ViewAttendanceV1" Title="View Attendance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetProjectID(source, eventArgs) {
            var HdnPrjKey = eventArgs.get_value();
            document.getElementById('<%=ddlProject_hid.ClientID %>').value = HdnPrjKey;
            <%-- alert(document.getElementById('<%=ddlWs_hid.ClientID %>').value);--%>
        }
...
<%--        function GetempnatureID(source, eventArgs) {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                        ...
                                                        <td>
                                                            <strong>Current Worksite&nbsp;
                                                                ...
                                                                <strong>Project&nbsp;
					                                                ...
					                                                <asp:HiddenField ID="ddlProject_hid" runat="server" />
                                                                    <asp:TextBox ID="txtSearchProject" runat="server" OnTextChanged="GetProject" AutoPostBack="true" Height="22px" Width="140px"></asp:TextBox>
                                                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters="" Enabled="True"
                                                                        MinimumPrefixLength="1" ServiceMethod="GetProjectList" ServicePath="" TargetControlID="txtSearchProject"
                                                                        UseContextKey="True" CompletionInterval="10" CompletionListCssClass="autocomplete_completionListElement"
                                                                        CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                                                        OnClientItemSelected="GetProjectID">
                                                                    </cc1:AutoCompleteExtender>
                                                                    <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" TargetControlID="txtSearchProject"
                                                                        WatermarkCssClass="watermark" WatermarkText="[Enter Project Name]"></cc1:TextBoxWatermarkExtender>


                                                                </strong>&nbsp;&nbsp;<strong> Department&nbsp;
                                                                            
					                                         <asp:HiddenField ID="ddlDepartment_hid" runat="server" />
                                                                    <asp:TextBox ID="textdept" OnTextChanged="Getdept" AutoPostBack="false" Height="22px" Width="120px" runat="server" runat="server"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp;
			                                                <asp:Button ID="btnDaySearch" ToolTip="Generate Day Report" runat="server" CssClass="btn btn-success"
                                                                OnClick="btnDaySearch_Click" Text="Day Report" />
                                                            &nbsp;
			                                                <asp:Button ID="btnDayExporttoExcel" ToolTip="Export to Excel Day Report" runat="server"
                                                                CssClass="btn btn-primary" Text="Export to Excel" OnClick="btnDayExporttoExcel_Click" />
                                                            &nbsp;<asp:Button ID="btnPrint" ToolTip="Print Day Report" runat="server" CssClass="btn btn-primary"
                                                                Text="Print" OnClick="btnPrint_Click" />
                                                            &nbsp;
			                                            <asp:Button ID="Button1" ToolTip="UnPunctual Employees" runat="server" CssClass="btn btn-primary"
                                                            Text="UnPunctual Employees" OnClick="Button1_Click" />
                                                            <asp:Label ID="lblFrom" runat="server" Text="From Date"></asp:Label>
                                                            &nbsp;<asp:TextBox ID="txtFromDate" runat="server" Height="22px" Width="100px" AccessKey="t" ToolTip="[Alt+t OR Alt+t+Enter]"></asp:TextBox>
                                                            &nbsp;
			                                                <asp:Image ID="imgFDay" runat="server" ImageUrl="~/images/Calendar_scheduleHS.png" />
                                                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd MMM yyyy" PopupButtonID="imgFDay"
                                                                PopupPosition="BottomLeft" TargetControlID="txtFromDate"></cc1:CalendarExtender>
                                                            &nbsp;
                                                             <asp:Label ID="lblToDate" runat="server" Text="To Date"></asp:Label>
                                                            &nbsp;<asp:TextBox ID="txtToDate" runat="server" Height="22px" Width="100px" AccessKey="t" ToolTip="[Alt+t OR Alt+t+Enter]"></asp:TextBox>
                                                            &nbsp;
			                                                <asp:Image ID="imgTDay" runat="server" ImageUrl="~/images/Calendar_scheduleHS.png" />
                                                            <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd MMM yyyy" PopupButtonID="imgTDay"
                                                                PopupPosition="BottomLeft" TargetControlID="txtToDate"></cc1:CalendarExtender>
                                                            &nbsp;
			                                                <asp:Button ID="btnDates" ToolTip="Between Dates Report" runat="server" CssClass="btn btn-success"
                                                                OnClick="btnDates_Click" Text="Search" />
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
			                                            ...
			                                            <asp:DropDownList ID="ddlYear" runat="server" CssClass="droplist"
                                                          ...
                                                          <asp:Button ID="btnSearch" CssClass="btn btn-success" runat="server" Text="Block Month" OnClick="btnSearch_Click" />
                                                            <asp:Button ID="btnMonthfirst" runat="server" CssClass="btn btn-success" Text="Calendar Month" OnClick="btnMonthfirst_Click" />
                                                            <asp:Button ID="btnMonthReport" ToolTip="Generate Month Report" runat="server" CssClass="btn btn-success"
                                                                OnClick="btnMonthReport_Click" Text="Month Report" Visible="false" />
                                                            <asp:Button ID="btnStrength" ToolTip="Generate Month Report" runat="server" Visible="false" CssClass="btn btn-success"
                                                                OnClick="btnStrength_Click" Text="Day Strength" />
                                                            &nbsp;
                                                            <asp:DropDownList ID="ddlExportExcel" runat="server" CssClass="droplist"
                                                                >

                                                                <asp:ListItem Value="01">Calendar Month</asp:ListItem>
                                                                <asp:ListItem Value="02">Block Month</asp:ListItem>
                                                            </asp:DropDownList>
                                                            &nbsp;
			                                            <asp:Button ID="btnMonth" ToolTip="Export to Excel Month Report" runat="server" CssClass="btn btn-primary"
                                                            Text="Export to Excel" OnClick="btnMonth_Click" />

                                                            &nbsp;
			                                            <asp:Button ID="btnMPrint" ToolTip="Print Month Report" runat="server" CssClass="btn btn-primary"
                        ...
                        <tr>
                            <td style="text-align: left" colspan="2">
                                ...
                                <uc1:Paging ID="EmpListPaging_Day" runat="server" Visible="false" />
                                <uc1:Paging ID="EmpListPaging" runat="server" />
                                <uc1:Paging ID="EmplistCalendar" runat="server" Visible="false" />
    ...
    <table id="tblAttStatus" runat="server" visible="false" width="100%">
        <tr>
            <td>
                <asp:GridView ID="grdAttStatusCount" runat="server" AutoGenerateColumns="false" CssClass="gridbdr">
                    <Columns>
                        <asp:BoundField DataField="AttStatusTYpe" HeaderText="Attendance Type" />
                        <asp:BoundField DataField="StatusCount" HeaderText="Count" />
                    </Columns>
                </asp:GridView>
                <asp:GridView ID="gdWSRPT" runat="server" AutoGenerateColumns="False" Width="50%" OnRowCommand="gdWSRPT_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Not Marked" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="HeaderTextAlign" FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <%--<asp:LinkButton ID="lnknotMarked" Text='<%# Eval("UnMarked_rt") %>' runat="server" CommandName="att" CommandArgument='<%#Eval("Site_ID") %>'></asp:LinkButton>--%>
                            </ItemTemplate>
                            <FooterTemplate>
                                <b>
