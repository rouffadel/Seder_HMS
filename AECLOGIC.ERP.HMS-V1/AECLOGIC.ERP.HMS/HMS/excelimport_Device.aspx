<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="excelimport_Device.aspx.cs"
    Inherits="AECLOGIC.ERP.HMS.excelimport_Device"  %>
        ...
        <tr>
            <td colspan="4" valign="top">
                ...
                <asp:HyperLink ID="hyperlink1" runat="server" Text="Download a sample Excel format..." Target="_blank"
                    NavigateUrl="~/Reports/Devices_Sample_Format.xls"></asp:HyperLink>
            ...
            <td colspan="4">
                <asp:GridView ID="gvMapping" runat="server"  CssClass="gridview" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField >
                        <HeaderTemplate> <span style="font-size:10px; font-family:Verdana"> Imported Devices from Excel...</span>  </HeaderTemplate>
                    
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblparti" Text='<% #Eval("DevicesName") %>'  Width="200px"></asp:Label>
                              <asp:Label runat="server" ID="lblpartdesc" Text='<% #Eval("Description") %>'></asp:Label>
                                </ItemTemplate>
                        </asp:TemplateField>
