...
{
    public partial class Reports_ExporttoExcel : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Session["RepCols"] != null)
                {
                    ...
                    cn.Open();
                    SqlCommand cmd = new SqlCommand("HR_EmpSalDetails", cn);
                    cmd.Parameters.Add(new SqlParameter("@Date", (DateTime)Session["rptDate"]));
