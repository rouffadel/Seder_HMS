<%@ Page Title="" Language="C#"   AutoEventWireup="True"
    CodeBehind="PFReport.aspx.cs" Inherits="AECLOGIC.ERP.HMS.PFReport" %>
    ...
    <asp:UpdatePanel runat="server" ID="updpnl">
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td>
                        <cc1:Accordion ID="PFRptAccordion" runat="server" HeaderCssClass="accordionHeader"
                            HeaderSelectedCssClass="accordionHeaderSelected" ContentCssClass="accordionContent"
                            AutoSize="None" FadeTransitions="false" TransitionDuration="50" FramesPerSecond="40"
                            RequireOpenedPane="false" SuppressHeaderPostbacks="true">
                            <Panes>
                                <cc1:AccordionPane ID="PFRptAccordionPane1" runat="server" HeaderCssClass="accordionHeader"
            ...
            <div>
                <asp:Panel ID="pnlPFReport" runat="server">
                    <rsweb:ReportViewer ID="PFRV" runat="server" Font-Names="Verdana" Font-Size="8pt"
