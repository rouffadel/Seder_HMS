...
{
    public partial class excelimport_Trades : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Columns.Add("TradesName", typeof(System.String));
                dt.AcceptChanges();
                ...
                foreach (GridViewRow row in gvMapping.Rows)
                {
                    ...
                    if (chkitem.Checked == true)
                    {
                        ...
                        int Output = AttendanceDAC.InsUpdCategories(0, dept);
                        if (Output == 1)
