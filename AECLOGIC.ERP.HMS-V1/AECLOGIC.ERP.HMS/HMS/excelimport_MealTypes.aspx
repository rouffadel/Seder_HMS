<%@ Page Language="C#"   AutoEventWireup="True" CodeBehind="excelimport_MealTypes.aspx.cs"
    Inherits="AECLOGIC.ERP.HMS.excelimport_MealTypes"  %>
    ...
    <table cellpadding="1" cellspacing="1" width="100%">
        ...
        <tr>
            <td colspan="4" valign="top">
                ...
                <asp:Button ID="Button1" runat="server" Text="Import" OnClick="btnImport_Click" CssClass="savebutton " AccessKey="i" ToolTip="[Alt+i OR Alt+i+Enter]"
                    Width="61px" />
                <asp:HyperLink ID="hyperlink1" runat="server" Text="Download a sample Excel format..." Target="_blank"
                    NavigateUrl="~/Reports/MealTypes_Sample_Format.xls"></asp:HyperLink>
        ...
        <tr>
         <td colspan="4">
         <asp:Panel ID="pnlcolorshow" runat="server" >
         <table>
            ...
            <td colspan="4">
                <asp:GridView ID="gvMapping" runat="server"  CssClass="gridview" HeaderStyle-CssClass="tableHead"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField >
                        <HeaderTemplate> <span style="font-size:10px; font-family:Verdana"> Imported Meal Types from Excel...</span>  </HeaderTemplate>
                    
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblparti" Text='<% #Eval("Meal_Types") %>' Width ="200px"></asp:Label> 
                             <asp:Label runat="server" ID="lblshort" Text='<% #Eval("ShortName") %>' ></asp:Label></ItemTemplate>
                        </asp:TemplateField>
