...
{
    public partial class EmpCustodianDocs : AECLOGIC.ERP.COMMON.WebFormMaster
    {
        int mid = 0;
        bool viewall;
        string menuname;
        ...
        //  int WSID = Convert.ToInt32(ddlWorkSite_hid.Value == "" ? "0" : ddlWorkSite_hid.Value);
         //   int Empid = Convert.ToInt32(ddlEmpid_hid.Value == "" ? "0" : ddlEmpid_hid.Value); 
            ...
            DataSet ds = AttendanceDAC.HR_EmpListForCustoDocs(objHrCommon, Empid, 0);
        ...
        protected void grdddlworksites_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // DropDownList RegrdddlHeads = (DropDownList)rownum.FindControl("RegrdddlHeads");
            ...
            if (DsEmployees.Tables[0].Rows.Count > 0)
            {
                ...
                //SelectedIndex='<%# GetInvHolderIndex(Eval("InvHolderID").ToString())%>'>
            }
        }
