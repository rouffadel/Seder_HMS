...
menuObjArray[9] = new Array();
menuObjArray[10] = new Array();
menuObjArray[11] = new Array();
menuObjArray[12] = new Array();
menuObjArray[13] = new Array();
menuObjArray[14] = new Array();
menuObjArray[15] = new Array();
...
function Init(objDiv)
{
        ...
        if (i == aLen)
    {
        		...
        		for(r=0;r < styleRules.length; r++)
		{
		    ...
		    if (itemContainerDiv.childNodes.Count > 0) {
